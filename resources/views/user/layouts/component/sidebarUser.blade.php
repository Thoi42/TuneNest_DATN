...
<li><a href="{{ route('wishlist.index') }}" class="menu-link menu-link_us-s {{ Route::currentRouteName() == 'customers.favourites' ? 'menu-link_active' : '' }}">Yêu thích</a></li>
...
<li><a href="{{ route('wishlist.index') }}" class="menu-link menu-link_us-s {{ Route::currentRouteName() == 'customer.wishlist' ? 'menu-link_active' : '' }}">Sản phẩm yêu thích</a></li>
