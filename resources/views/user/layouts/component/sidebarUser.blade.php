...
<li><a href="{{route('customer.account_detail')}}" class="menu-link menu-link_us-s {{ Route::currentRouteName() == 'customer.orders.history' ? 'menu-link_active' : '' }}">Thông tin cá nhân</a></li>
