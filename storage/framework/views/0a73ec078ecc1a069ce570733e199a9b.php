    ...
    <div class="container d-flex align-items-center h-100">
        ...
        <div class="logo">
            <a href="<?php echo e(route('home.index')); ?>">
                <img src="<?php echo e(asset('assets/images/logo.jpg')); ?>" alt="Uomo" class="logo__image d-block" />
            </a>
        </div>
            ...
            <div class="overflow-hidden">
                <ul class="navigation__list list-unstyled position-relative">
                    <li class="navigation__item">
                        <a href="<?php echo e(route('home.index')); ?>" class="navigation__link">Trang chủ</a>
                    </li>
                    <li class="navigation__item">
                        <a href="<?php echo e(route('shop.index')); ?>" class="navigation__link">Cửa hàng</a>
                    </li>
                    <li class="navigation__item">
                        <a href="
...
</div><?php /**PATH E:\laragon2\www\dat\TuneNest_DATN\resources\views/user/layouts/component/header-mobile.blade.php ENDPATH**/ ?>